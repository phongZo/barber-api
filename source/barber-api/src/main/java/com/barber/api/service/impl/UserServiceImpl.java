package com.barber.api.service.impl;

import com.barber.api.config.SecurityConstant;
...
public class UserServiceImpl implements UserDetailsService {
    ...
    public OAuth2AccessToken getAccessTokenForCustomer(ClientDetails client, TokenRequest tokenRequest, String password, String email, AuthorizationServerTokenServices tokenServices) throws GeneralSecurityException, IOException {
        Map<String, String> requestParameters = new HashMap<>();
        requestParameters.put("grantType", SecurityConstant.GRANT_TYPE_CUSTOMER);
        ...
        if(user == null || !Objects.equals(BarberConstant.STATUS_ACTIVE, user.getStatus())){
    ...
    public BarberJwt getAddInfoFromToken() {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (oauthDetails != null) {
                ...
                if (encodedData != null && !encodedData.isEmpty()) {
                    return BarberJwt.decode(encodedData);
                }
                return null;
            }
        }
