...
@Slf4j
@Data
public class BarberJwt implements Serializable {
    ...
    private Integer userKind = -1; //loại customer là admin hay là gì
    ...
    public static BarberJwt decode(String input){
        BarberJwt result = null;
        try {
            String[] items = ZipUtils.unzipString(input).split(DELIM,11);
            if(items.length >= 10){
                result = new BarberJwt();
