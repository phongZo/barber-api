...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.addFilterAfter(jsonFilter, BasicAuthenticationFilter.class)
                ...
                .antMatchers("/v1/schedule/client-list").permitAll()
                .antMatchers("/v1/booking/client-create", "/v1/booking/client-list", "/v1/booking/client-get", "/v1/booking/client-cancel").permitAll()
