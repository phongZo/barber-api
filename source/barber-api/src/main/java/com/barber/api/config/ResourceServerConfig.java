...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.addFilterAfter(jsonFilter, BasicAuthenticationFilter.class)
                ...
                .antMatchers( "/v1/customer/signup").permitAll()
                ...
                .antMatchers("/v1/service/client-list", "/v1/service/client-get/**").permitAll()
                .antMatchers("/v1/booking/client-create", "/v1/booking/client-list", "/v1/booking/client-get", "/v1/booking/client-cancel", "/v1/booking/confirm-create", "/v1/booking/confirm-cancel").permitAll()
                .antMatchers("/v1/booking-service/client-list").permitAll()
